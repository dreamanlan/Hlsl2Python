...
typedef vector<half, 2> short2;
typedef vector<half, 3> short3;
typedef vector<half, 4> short4;
typedef matrix<half, 2, 2> short2x2;
typedef matrix<half, 3, 3> short3x3;
typedef matrix<half, 4, 4> short4x4;
