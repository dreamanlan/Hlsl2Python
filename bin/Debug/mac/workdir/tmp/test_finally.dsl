...
func(spec[nothing ], float2, glsl_vec2 )
params(var(spec[nothing ], float, arg ) )
{
	return <- float2(arg, arg );
};
func(spec[nothing ], float3, glsl_vec3 )
params(var(spec[nothing ], float, arg ) )
{
	return <- float3(arg, arg, arg );
};
func(spec[nothing ], float4, glsl_vec4 )
params(var(spec[nothing ], float, arg ) )
{
	return <- float4(arg, arg, arg, arg );
};
func(spec[nothing ], double2, glsl_dvec2 )
params(var(spec[nothing ], double, arg ) )
{
	return <- double2(arg, arg );
};
func(spec[nothing ], double3, glsl_dvec3 )
params(var(spec[nothing ], double, arg ) )
{
	return <- double3(arg, arg, arg );
};
func(spec[nothing ], double4, glsl_dvec4 )
params(var(spec[nothing ], double, arg ) )
{
	return <- double4(arg, arg, arg, arg );
};
func(spec[nothing ], int2, glsl_ivec2 )
params(var(spec[nothing ], int, arg ) )
{
	return <- int2(arg, arg );
};
func(spec[nothing ], int3, glsl_ivec3 )
params(var(spec[nothing ], int, arg ) )
{
	return <- int3(arg, arg, arg );
};
func(spec[nothing ], int4, glsl_ivec4 )
params(var(spec[nothing ], int, arg ) )
{
	return <- int4(arg, arg, arg, arg );
};
func(spec[nothing ], uint2, glsl_uvec2 )
params(var(spec[nothing ], uint, arg ) )
{
	return <- uint2(arg, arg );
};
func(spec[nothing ], uint3, glsl_uvec3 )
params(var(spec[nothing ], uint, arg ) )
{
	return <- uint3(arg, arg, arg );
};
func(spec[nothing ], uint4, glsl_uvec4 )
params(var(spec[nothing ], uint, arg ) )
{
	return <- uint4(arg, arg, arg, arg );
};
func(spec[nothing ], bool2, glsl_bvec2 )
params(var(spec[nothing ], bool, arg ) )
{
	return <- bool2(arg, arg );
};
func(spec[nothing ], bool3, glsl_bvec3 )
params(var(spec[nothing ], bool, arg ) )
{
	return <- bool3(arg, arg, arg );
};
func(spec[nothing ], bool4, glsl_bvec4 )
params(var(spec[nothing ], bool, arg ) )
{
	return <- bool4(arg, arg, arg, arg );
};
func(spec[nothing ], float2x2, glsl_mat2 )
params(var(spec[nothing ], float, arg ) )
{
	return <- float2x2(arg, 0.0, 0.0, arg );
};
func(spec[nothing ], float3x3, glsl_mat3 )
params(var(spec[nothing ], float, arg ) )
{
	return <- float3x3(arg, 0.0, 0.0, 0.0, arg, 0.0, 0.0, 0.0, arg );
};
func(spec[nothing ], float4x4, glsl_mat4 )
params(var(spec[nothing ], float, arg ) )
{
	return <- float4x4(arg, 0.0, 0.0, 0.0, 0.0, arg, 0.0, 0.0, 0.0, 0.0, arg, 0.0, 0.0, 0.0, 0.0, arg );
};
func(spec[nothing ], double2x2, glsl_dmat2 )
params(var(spec[nothing ], double, arg ) )
{
	return <- double2x2(arg, 0.0, 0.0, arg );
};
func(spec[nothing ], double3x3, glsl_dmat3 )
params(var(spec[nothing ], double, arg ) )
{
	return <- double3x3(arg, 0.0, 0.0, 0.0, arg, 0.0, 0.0, 0.0, arg );
};
func(spec[nothing ], double4x4, glsl_dmat4 )
params(var(spec[nothing ], double, arg ) )
{
	return <- double4x4(arg, 0.0, 0.0, 0.0, 0.0, arg, 0.0, 0.0, 0.0, 0.0, arg, 0.0, 0.0, 0.0, 0.0, arg );
};
func(spec[nothing ], float2x2, glsl_inverse )
params(var(spec[nothing ], float2x2, m ) )
{
...
func(spec[nothing ], float3x3, glsl_inverse )
params(var(spec[nothing ], float3x3, m ) )
{
...
func(spec[nothing ], float4x4, glsl_inverse )
params(var(spec[nothing ], float4x4, m ) )
{
	var(spec[nothing ], float, n11 ) = m[0 ][0 ],
	var(spec[nothing ], float, n12 ) = m[1 ][0 ],
	var(spec[nothing ], float, n13 ) = m[2 ][0 ],
	var(spec[nothing ], float, n14 ) = m[3 ][0 ];
	var(spec[nothing ], float, n21 ) = m[0 ][1 ],
	var(spec[nothing ], float, n22 ) = m[1 ][1 ],
	var(spec[nothing ], float, n23 ) = m[2 ][1 ],
	var(spec[nothing ], float, n24 ) = m[3 ][1 ];
	var(spec[nothing ], float, n31 ) = m[0 ][2 ],
	var(spec[nothing ], float, n32 ) = m[1 ][2 ],
	var(spec[nothing ], float, n33 ) = m[2 ][2 ],
	var(spec[nothing ], float, n34 ) = m[3 ][2 ];
	var(spec[nothing ], float, n41 ) = m[0 ][3 ],
	var(spec[nothing ], float, n42 ) = m[1 ][3 ],
	var(spec[nothing ], float, n43 ) = m[2 ][3 ],
	var(spec[nothing ], float, n44 ) = m[3 ][3 ];
	...
	var(spec[nothing ], float, idet ) = 1.0 / det;
...
func(spec[nothing ], double2x2, glsl_inverse )
params(var(spec[nothing ], double2x2, m ) )
{
...
func(spec[nothing ], double3x3, glsl_inverse )
params(var(spec[nothing ], double3x3, m ) )
{
...
func(spec[nothing ], double4x4, glsl_inverse )
params(var(spec[nothing ], double4x4, m ) )
{
	var(spec[nothing ], double, n11 ) = m[0 ][0 ],
	var(spec[nothing ], double, n12 ) = m[1 ][0 ],
	var(spec[nothing ], double, n13 ) = m[2 ][0 ],
	var(spec[nothing ], double, n14 ) = m[3 ][0 ];
	var(spec[nothing ], double, n21 ) = m[0 ][1 ],
	var(spec[nothing ], double, n22 ) = m[1 ][1 ],
	var(spec[nothing ], double, n23 ) = m[2 ][1 ],
	var(spec[nothing ], double, n24 ) = m[3 ][1 ];
	var(spec[nothing ], double, n31 ) = m[0 ][2 ],
	var(spec[nothing ], double, n32 ) = m[1 ][2 ],
	var(spec[nothing ], double, n33 ) = m[2 ][2 ],
	var(spec[nothing ], double, n34 ) = m[3 ][2 ];
	var(spec[nothing ], double, n41 ) = m[0 ][3 ],
	var(spec[nothing ], double, n42 ) = m[1 ][3 ],
	var(spec[nothing ], double, n43 ) = m[2 ][3 ],
	var(spec[nothing ], double, n44 ) = m[3 ][3 ];
	...
	var(spec[nothing ], double, idet ) = 1.0 / det;
...
func(spec[nothing ], float2, glsl_vec2 )
params(var(spec[nothing ], double2, arg ) )
{
	return <- float2(arg );
};
func(spec[nothing ], float2, glsl_vec2 )
params(var(spec[nothing ], int2, arg ) )
{
	return <- float2(arg );
};
func(spec[nothing ], float2, glsl_vec2 )
params(var(spec[nothing ], uint2, arg ) )
{
	return <- float2(arg );
};
func(spec[nothing ], float2, glsl_vec2 )
params(var(spec[nothing ], bool2, arg ) )
{
	return <- float2(arg );
};
func(spec[nothing ], double2, glsl_dvec2 )
params(var(spec[nothing ], float2, arg ) )
{
	return <- double2(arg );
};
func(spec[nothing ], double2, glsl_dvec2 )
...
func(spec[nothing ], float3, glsl_vec3 )
params(var(spec[nothing ], double3, arg ) )
{
	return <- float3(arg );
};
func(spec[nothing ], float3, glsl_vec3 )
params(var(spec[nothing ], int3, arg ) )
{
	return <- float3(arg );
};
func(spec[nothing ], float3, glsl_vec3 )
params(var(spec[nothing ], uint3, arg ) )
{
	return <- float3(arg );
};
func(spec[nothing ], float3, glsl_vec3 )
params(var(spec[nothing ], bool3, arg ) )
{
	return <- float3(arg );
};
func(spec[nothing ], double3, glsl_dvec3 )
params(var(spec[nothing ], float3, arg ) )
{
	return <- double3(arg );
};
func(spec[nothing ], double3, glsl_dvec3 )
...
func(spec[nothing ], float4, glsl_vec4 )
params(var(spec[nothing ], double4, arg ) )
{
	return <- float4(arg );
};
func(spec[nothing ], float4, glsl_vec4 )
params(var(spec[nothing ], int4, arg ) )
{
	return <- float4(arg );
};
func(spec[nothing ], float4, glsl_vec4 )
params(var(spec[nothing ], uint4, arg ) )
{
	return <- float4(arg );
};
func(spec[nothing ], float4, glsl_vec4 )
params(var(spec[nothing ], bool4, arg ) )
{
	return <- float4(arg );
};
func(spec[nothing ], double4, glsl_dvec4 )
params(var(spec[nothing ], float4, arg ) )
{
	return <- double4(arg );
};
func(spec[nothing ], double4, glsl_dvec4 )
...
func(spec[nothing ], int2, greaterThan )
params(var(spec[nothing ], float2, x ), var(spec[nothing ], float2, y ) )
{
	return <- int2(1, 1 ) - int2(step(x, y ) );
};
func(spec[nothing ], int3, greaterThan )
params(var(spec[nothing ], float3, x ), var(spec[nothing ], float3, y ) )
{
	return <- int3(1, 1, 1 ) - int3(step(x, y ) );
};
func(spec[nothing ], int4, greaterThan )
params(var(spec[nothing ], float4, x ), var(spec[nothing ], float4, y ) )
{
	return <- int4(1, 1, 1, 1 ) - int4(step(x, y ) );
};
func(spec[nothing ], int2, lessThan )
params(var(spec[nothing ], float2, x ), var(spec[nothing ], float2, y ) )
{
	return <- int2(1.0, 1.0 ) - int2(step(y, x ) );
};
func(spec[nothing ], int3, lessThan )
params(var(spec[nothing ], float3, x ), var(spec[nothing ], float3, y ) )
{
	return <- int3(1.0, 1.0, 1.0 ) - int3(step(y, x ) );
};
func(spec[nothing ], int4, lessThan )
params(var(spec[nothing ], float4, x ), var(spec[nothing ], float4, y ) )
{
	return <- int4(1.0, 1.0, 1.0, 1.0 ) - int4(step(y, x ) );
};
func(spec[nothing ], int2, greaterThanEqual )
params(var(spec[nothing ], float2, x ), var(spec[nothing ], float2, y ) )
{
	return <- int2(step(y, x ) );
};
func(spec[nothing ], int3, greaterThanEqual )
params(var(spec[nothing ], float3, x ), var(spec[nothing ], float3, y ) )
{
	return <- int3(step(y, x ) );
};
func(spec[nothing ], int4, greaterThanEqual )
params(var(spec[nothing ], float4, x ), var(spec[nothing ], float4, y ) )
{
	return <- int4(step(y, x ) );
};
func(spec[nothing ], int2, lessThanEqual )
params(var(spec[nothing ], float2, x ), var(spec[nothing ], float2, y ) )
{
	return <- int2(step(x, y ) );
};
func(spec[nothing ], int3, lessThanEqual )
params(var(spec[nothing ], float3, x ), var(spec[nothing ], float3, y ) )
{
	return <- int3(step(x, y ) );
};
func(spec[nothing ], int4, lessThanEqual )
params(var(spec[nothing ], float4, x ), var(spec[nothing ], float4, y ) )
{
	return <- int4(step(x, y ) );
};
func(spec[nothing ], int2, equal )
params(var(spec[nothing ], float2, x ), var(spec[nothing ], float2, y ) )
{
	return <- int2(step(x, y ) * step(y, x ) );
};
func(spec[nothing ], int3, equal )
params(var(spec[nothing ], float3, x ), var(spec[nothing ], float3, y ) )
{
	return <- int3(step(y, x ) * step(y, x ) );
};
func(spec[nothing ], int4, equal )
params(var(spec[nothing ], float4, x ), var(spec[nothing ], float4, y ) )
{
	return <- int4(step(y, x ) * step(y, x ) );
};
func(spec[nothing ], int2, notEqual )
params(var(spec[nothing ], float2, x ), var(spec[nothing ], float2, y ) )
{
	return <- (int2(1, 1 ) - int2(step(x, y ) ) ) * (int2(1, 1 ) - int2(step(y, x ) ) );
};
func(spec[nothing ], int3, notEqual )
params(var(spec[nothing ], float3, x ), var(spec[nothing ], float3, y ) )
{
	return <- (int3(1, 1, 1 ) - int3(step(x, y ) ) ) * (int3(1, 1, 1 ) - int3(step(y, x ) ) );
};
func(spec[nothing ], int4, notEqual )
params(var(spec[nothing ], float4, x ), var(spec[nothing ], float4, y ) )
{
	return <- (int4(1, 1, 1, 1 ) - int4(step(x, y ) ) ) * (int4(1, 1, 1, 1 ) - int4(step(y, x ) ) );
};
func(spec[nothing ], int2, greaterThan )
params(var(spec[nothing ], double2, x ), var(spec[nothing ], double2, y ) )
{
	return <- int2(1, 1 ) - int2(step(x, y ) );
};
func(spec[nothing ], int3, greaterThan )
params(var(spec[nothing ], double3, x ), var(spec[nothing ], double3, y ) )
{
	return <- int3(1, 1, 1 ) - int3(step(x, y ) );
};
func(spec[nothing ], int4, greaterThan )
params(var(spec[nothing ], double4, x ), var(spec[nothing ], double4, y ) )
{
	return <- int4(1, 1, 1, 1 ) - int4(step(x, y ) );
};
func(spec[nothing ], int2, lessThan )
...
func(spec[nothing ], int2, greaterThan )
params(var(spec[nothing ], int2, x ), var(spec[nothing ], int2, y ) )
{
	return <- int2(1, 1 ) - int2(step(x, y ) );
};
func(spec[nothing ], int3, greaterThan )
params(var(spec[nothing ], int3, x ), var(spec[nothing ], int3, y ) )
{
	return <- int3(1, 1, 1 ) - int3(step(x, y ) );
};
func(spec[nothing ], int4, greaterThan )
params(var(spec[nothing ], int4, x ), var(spec[nothing ], int4, y ) )
{
	return <- int4(1, 1, 1, 1 ) - int4(step(x, y ) );
};
func(spec[nothing ], int2, lessThan )
...
func(spec[nothing ], int2, greaterThan )
params(var(spec[nothing ], uint2, x ), var(spec[nothing ], uint2, y ) )
{
	return <- int2(1, 1 ) - int2(step(x, y ) );
};
func(spec[nothing ], int3, greaterThan )
params(var(spec[nothing ], uint3, x ), var(spec[nothing ], uint3, y ) )
{
	return <- int3(1, 1, 1 ) - int3(step(x, y ) );
};
func(spec[nothing ], int4, greaterThan )
params(var(spec[nothing ], uint4, x ), var(spec[nothing ], uint4, y ) )
{
	return <- int4(1, 1, 1, 1 ) - int4(step(x, y ) );
};
func(spec[nothing ], int2, lessThan )
...
func(spec[nothing ], int2, greaterThan )
params(var(spec[nothing ], bool2, x ), var(spec[nothing ], bool2, y ) )
{
	return <- int2(1, 1 ) - int2(step(x, y ) );
};
func(spec[nothing ], int3, greaterThan )
params(var(spec[nothing ], bool3, x ), var(spec[nothing ], bool3, y ) )
{
	return <- int3(1, 1, 1 ) - int3(step(x, y ) );
};
func(spec[nothing ], int4, greaterThan )
params(var(spec[nothing ], bool4, x ), var(spec[nothing ], bool4, y ) )
{
	return <- int4(1, 1, 1, 1 ) - int4(step(x, y ) );
};
func(spec[nothing ], int2, lessThan )
...
func(spec[nothing ], float, noise )
params(var(spec[in, nothing ], const float2, x ) )
{
...
func(spec[nothing ], float, noise )
params(var(spec[in, nothing ], const float3, x ) )
{
...
func(spec[nothing ], float2x2, rot )
params(var(spec[in, nothing ], const float, a ) )
{
...
params(var(spec[in, nothing ], float3, p ) )
{
...
params(var(spec[in, nothing ], float, n ) )
{
	return <- (frac(sin(n ) * 43758.545299999998 ) );
};
func(spec[nothing ], bool, intersectPlane )
params(var(spec[in, nothing ], const float3, ro ), var(spec[in, nothing ], const float3, rd ), var(spec[in, nothing ], const float, height ), var(spec[inout, nothing ], float, dist ) )
{
	var(spec[nothing ], bool, _func_ret_val_183 );
	var(spec[nothing ], bool, _func_ret_flag_183 ) = false;
	if(rd.y  == 0.0 )
	{
		_func_ret_flag_183 = true;
		_func_ret_val_183 = false;
	};
	if(! _func_ret_flag_183 )
	{
	...
	return <- _func_ret_val_183;
};
var(spec[static, nothing ], float3, lig ) = normalize(float3(0.29999999999999999, 0.5, 0.59999999999999998 ) );
func(spec[nothing ], float3, bgColor )
params(var(spec[in, nothing ], const float3, rd ) )
{
	var(spec[nothing ], float, sun ) = clamp(dot(lig, rd ), 0.0, 1.0 );
	var(spec[nothing ], float3, col ) = float3(0.5, 0.52000000000000002, 0.55000000000000004 ) - rd.y  * 0.20000000000000001 * float3(1.0, 0.80000000000000004, 1.0 ) + 0.1125;
	col += float3(1.0, 0.59999999999999998, 0.10000000000000001 ) * pow(sun, 8.0 );
	col *= 0.94999999999999996;
	return <- (col );
};
func(spec[nothing ], float, cloudMap )
params(var(spec[in, nothing ], const float3, p ), var(spec[in, nothing ], const float, ani ) )
{
	var(spec[nothing ], float3, r ) = p / 260.4167;
...
func(spec[nothing ], float3, raymarchClouds )
params(var(spec[in, nothing ], const float3, ro ), var(spec[in, nothing ], const float3, rd ), var(spec[in, nothing ], const float3, bgc ), var(spec[in, nothing ], const float3, fgc ), var(spec[in, nothing ], const float, startdist ), var(spec[in, nothing ], const float, maxdist ), var(spec[in, nothing ], const float, ani ) )
{
	var(spec[nothing ], float, t ) = startdist + 5.208333 * hash(rd.x  + 35.698722099999998 * rd.y  + (iTime + 285.0 ) );
	var(spec[nothing ], float4, sum ) = glsl_vec4(0.0 );
	var(spec[nothing ], bool, _cont_flag_187 ) = false;
	block
	{
		...
		if(! _cont_flag_187 )
		{
			...
			var(spec[nothing ], float, dif ) = clamp(0.10000000000000001 + 0.80000000000000004 * (a - cloudMap(pos + lig * 0.14999999999999999 * 260.4167, ani ) ), 0.0, 0.5 );
...
func(spec[nothing ], float, terrainMap )
params(var(spec[in, nothing ], const float3, p ) )
{
...
func(spec[nothing ], float3, raymarchTerrain )
params(var(spec[in, nothing ], const float3, ro ), var(spec[in, nothing ], const float3, rd ), var(spec[in, nothing ], const float3, bgc ), var(spec[in, nothing ], const float, startdist ), var(spec[inout, nothing ], float, dist ) )
{
	var(spec[nothing ], float, t ) = startdist;
	var(spec[nothing ], float4, sum ) = glsl_vec4(0.0 );
	var(spec[nothing ], bool, hit ) = false;
	var(spec[nothing ], float3, col ) = bgc;
	var(spec[nothing ], bool, _br_flag_190 ) = false;
	block
	{
		var(spec[nothing ], int, i ) = 0;
		if(! _br_flag_190 )
	...
	if(hit )
	{
		...
		pos = ro + t * rd;
		var(spec[nothing ], float3, dx ) = float3(10.00, 0.0, 0.0 );
		var(spec[nothing ], float3, dz ) = float3(0.0, 0.0, 10.00 );
		var(spec[nothing ], float3, normal ) = float3(0.0, 0.0, 0.0 );
		normal.x  = (terrainMap(pos + dx ) - terrainMap(pos - dx ) ) / 20.00;
		normal.z  = (terrainMap(pos + dz ) - terrainMap(pos - dz ) ) / 20.00;
		normal.y  = 1.0;
...
func(spec[nothing ], float, waterMap )
params(var(spec[nothing ], float2, pos ) )
{
...
params(var(spec[out, nothing ], float4, fragColor ), var(spec[in, nothing ], float2, fragCoord ) )
{
	...
	var(spec[nothing ], float, fresnel ),
	var(spec[nothing ], float, refldist ) = 5000.0,
	var(spec[nothing ], float, maxdist ) = 5000.0;
	var(spec[nothing ], bool, reflected ) = false;
	var(spec[nothing ], float3, normal ),
	var(spec[nothing ], float3, col ) = bgColor(rd );
	var(spec[nothing ], float3, roo ) = ro,
	var(spec[nothing ], float3, rdo ) = rd,
	var(spec[nothing ], float3, bgc ) = col;
	if(intersectPlane(ro, rd, 0.0, refldist ) && refldist < 200.0 )
	{
		...
		normal.x  = - bumpfactor * (waterMap(coord + dx ) - waterMap(coord - dx ) ) / 0.20;
		normal.z  = - bumpfactor * (waterMap(coord + dz ) - waterMap(coord - dz ) ) / 0.20;
		normal = normalize(normal );
	...
	if(reflected )
	{
		...
		var(spec[nothing ], float3, refr ) = refract(rdo, normal, 0.7501876 );
...
func(spec[nothing ], td_float_x4, glsl_float_x4_ctor )
params(var(spec[nothing ], float, v0 ), var(spec[nothing ], float, v1 ), var(spec[nothing ], float, v2 ), var(spec[nothing ], float, v3 ) )
{
	var(spec[nothing ], float, __arr_tmp[4 ] ) = 
	{
		v0,
		v1,
		v2,
...
func(spec[nothing ], td_vec3_x4, glsl_vec3_x4_ctor )
params(var(spec[nothing ], float3, v0 ), var(spec[nothing ], float3, v1 ), var(spec[nothing ], float3, v2 ), var(spec[nothing ], float3, v3 ) )
{
	var(spec[nothing ], float3, __arr_tmp[4 ] ) = 
	{
		v0,
		v1,
		v2,
